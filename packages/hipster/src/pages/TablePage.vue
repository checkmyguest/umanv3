        ...
        <div class="card">
            <div class="section">
                <div class="button-container">
                    <InputSearchVue ref="inputSearch" :modelValue="search" :getValue="getSearch"/>
                    <DropdownVue type="secondary" text="Filter" id="newUnavaibility" iconLeft="Filter" :actions="actions" />
                    <DropdownVue type="primary" text="Nouvelle événement" id="newEvent" :actions="actions" />
                </div>
                <TableVue :columns="columnsFormat" :dataTable="dataSample" :searchItem="search"/>
            </div>
        </div>
    </div>
</template>
