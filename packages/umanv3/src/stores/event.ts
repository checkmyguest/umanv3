...
export const useEventStore = defineStore({
  ...
  state: () =>
    ({
      ...
      tagsByResaId: [] as Array<any>,
      paymentsByResaId: [] as Array<any>,
      identityFilesById: [] as Array<any>,
      selfieFilesById: [] as Array<any>,
      housingById: {},
      tipByHousingId: [] as Array<any>,
      accountManagerByHousingId: [] as Array<any>,
      statusByHousingId: {},
      logsByHousingIdAndResaId: [] as Array<any>,
      bedroomByHousingId: [] as Array<any>,
      chatByPhone: [] as Array<any>,
      airbnbTeam: [] as Array<any>,
      isAccountManager: [] as Array<any>,
      platformAccount: [] as Array<any>,
    } as EventState),
  getters: {
    getPage(): IEvents[][]{
      return this.events;
